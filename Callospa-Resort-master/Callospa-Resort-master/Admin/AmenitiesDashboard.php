...
$sql1 = "SELECT amenity_reservation_id, first_name, middle_name, last_name, contact_number, email, package_category, package, check_in_date, check_in_time, guests, total_cost, deposit_amount, remaining_balance, payment_method, proof_of_payment, reservation_date FROM amenity_reservations";
...
<head>
  ...
  <!-- My CSS -->
  <link rel="stylesheet" href="AmenitiesDashboard.css" />
    ...
    <main>
      <div class="head-title">
        <div class="left">
          ...
          <ul class="breadcrumb">
            <li>
              <a href="#">Amenities Reservation Dashboard</a>
            </li>
          ...
          <table>
            ...
            <tbody>
              <?php while ($row = $result1->fetch_assoc()): ?>
                <tr>
                  <td><?php echo htmlspecialchars($row['amenity_reservation_id']); ?></td>
                  <td>
                    <?php
