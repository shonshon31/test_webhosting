...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO package_reservations (first_name, middle_name, last_name, contact_number, email, handle, sources, source_other, package, check_in_date, check_out_date, check_in_time, check_out_time, guests, additional_guest, total_cost, deposit_amount, remaining_balance, payment_method, proof_of_payment) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    $stmt->bind_param("sssisssssssssiidddss", $first_name, $middle_name, $last_name, $contact_number, $email, $handle, $sources, $source_other, $package, $check_in_date, $check_out_date, $check_in_time, $check_out_time, $guests, $additional_guest, $total_cost, $deposit_amount, $remaining_balance, $payment_method, $proof_of_payment);
                    ...
                    <nav class='main-nav'>
                        <ul class='nav-links'>
                            ...
                            foreach ($navLinks as $name => $link) {
                                ...
                                $isActive = ($currentPage == $linkBase || ($currentPage == 'SubmitPackageReservation.php' && $linkBase == 'PackagesPage.php')) ? 'active' : '';
