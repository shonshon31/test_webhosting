...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['proof_of_payment']) && $_FILES['proof_of_payment']['error'] == UPLOAD_ERR_OK) {
        ...
        if (in_array($fileExtension, $allowedExtensions)) {
            $uploadFileDir = './RoomsProofOfPayment';
    ...
    $stmt = $conn->prepare("INSERT INTO room_reservations (first_name, middle_name, last_name, contact_number, email, handle, sources, source_other, room, check_in_date, check_out_date, check_in_time, check_out_time, guests, additional_guest, total_cost, deposit_amount, remaining_balance, payment_method, proof_of_payment) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
    ...
    if ($stmt->execute()) {
        $title = "Callospa Resort and Residences";
        $mainHeader = "CALLOSPA";
        $subHeader = "Resort and Residence";
        $mainTitle = "RESERVATION CONFIRMATION";
        $subTitle = "Thank you for choosing Callospa Resort! Your room reservation has been successfully completed.";
...
?>
        ...
        <head>
            ...
            <link rel='stylesheet' href='SubmitRoomReservation.css'>
        ...
        <body>
                    ...
                    <nav class='main-nav'>
                        <ul class='nav-links'>
                            ...
                            foreach ($navLinks as $name => $link) {
                                ...
                                $isActive = ($currentPage == $linkBase || ($currentPage == 'SubmitRoomReservation.php' && $linkBase == 'RoomsPage.php')) ? 'active' : '';
            ...
            <main>
                ...
                <div class='container'>
                    ...
                    <p><strong>Room:</strong> <?php echo htmlspecialchars($room, ENT_QUOTES, 'UTF-8'); ?></p>
                    ...
                    <?php if ($proof_of_payment): ?>
                        <div class='payment-image'>
                            ...
                            <img src='<?php echo htmlspecialchars($uploadFileDir . '/' . $proof_of_payment, ENT_QUOTES, 'UTF-8'); ?>' alt='Payment Confirmation' style='max-width: 100%; height: auto;'>
